...
function Menu({
  ...
  return (
    ...
    <ul {...getMenuProps({ref: listRef})}>
      ...
      {/*
        👹
        This is a closed li item which takes the height of all our items added together.
        This way the scrollbar is accurate.
        react-virtual then adds and removes our actual list items (see below)
